...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "rviz_config",
            default_value="/home/ros/ros_wrapper/install/r12_move_config/share/r12_move_config/config/moveit.rviz",
...
def launch_setup(context, *args, **kwargs):
    ...
    rviz_config = PathJoinSubstitution(
        [FindPackageShare(""), "launch", rviz_base]
    )
    ...
    ros2_controllers_path = os.path.join(
        get_package_share_directory("r12_move_config"),
        "config",
    ...
    arm_controller_spawner = Node(
        package="controller_manager",
        executable="spawner",
        arguments=["r12_arm_controller", "-c", "/controller_manager"],
    )
